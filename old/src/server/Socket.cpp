...
Socket::Socket(int family, int type, int protocol, const ServerBlock &sb, size_t port) : _sb(sb)
{
 ...
 */
void	Socket::socket_getRead_and_write_size()
{
	int read_size = 0;
...
// void	Socket::set_server_block(ServerBlock sb)
// {
// 	_sb = sb;
// }

ServerBlock	Socket::getServerBlock()
{
	return (_sb);
}
